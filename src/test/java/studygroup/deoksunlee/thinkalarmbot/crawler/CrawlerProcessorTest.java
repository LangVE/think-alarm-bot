...
public class CrawlerProcessorTest {
    private Logger logger = LoggerFactory.getLogger(CrawlerProcessorTest.class);
    ...
    public void getByHttpClient() throws IOException {
        ...
        // when
        String actual = CrawlerProcessor.getByHttpClient(URL);
        logger.debug("actual : " + actual);
    ...
    public void parse() throws Exception {
        ...
        String actual = CrawlerProcessor.parse(xml, xpathExpression);
        logger.debug("actual : " + actual);
    ...
    @Test
    public void parse_targetxml() throws Exception {
        // given
        String xml = getXML();
